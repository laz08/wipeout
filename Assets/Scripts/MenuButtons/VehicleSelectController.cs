...
public class VehicleSelectController : MonoBehaviour {
	...
	private static string MAP_SCREEN_NAME = "MapSelector";
	...
	public void onKirbySelected(){
		...
		AssemblyCSharp.SceneController.Load (MAP_SCREEN_NAME, SELECTED_VEHICLE_KEY, KIRBY_VEHICLE);
	}

	public void onCorvetteSelected(){
	
		AssemblyCSharp.SceneController.Load (MAP_SCREEN_NAME, SELECTED_VEHICLE_KEY, CORVETTE_VEHICLE);
	}

	public void onBoatSelected(){
	
		AssemblyCSharp.SceneController.Load (MAP_SCREEN_NAME, SELECTED_VEHICLE_KEY, BOAT_VEHICLE);
	}
